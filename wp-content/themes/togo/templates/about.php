    ...
    <div class="about-banner__wrapper">
      ...
      <div class="about-banner__b"> 
        <div class="about__banner"> 
          ...
          <div class="about__banner-i" id="elem__4"> <img src="<?php bloginfo('template_directory'); ?>/svg/about__animation/element__4.svg" alt="icons"></div>
          <div class="about__banner-i" id="elem__5"> <img src="<?php bloginfo('template_directory'); ?>/svg/about__animation/element__5.svg" alt="icons"></div>
          <div class="about__banner-i" id="elem__6"> <img src="<?php bloginfo('template_directory'); ?>/svg/about__animation/element__6.svg" alt="icons"></div>
          <div class="about__banner-i" id="elem__7"> <img src="<?php bloginfo('template_directory'); ?>/svg/about__animation/element__7.svg" alt="icons"></div>
          <div class="about__line" id="lines">
            <div class="about__line__progress" id="lines__p"></div>
          </div>
        </div>
      </div>
      <div class="about-banner__m"><img src="<?php bloginfo('template_directory'); ?>/svg/about/media.svg" alt="icons"></div>
    </div>
  </div>
</section>
    ...
    <div class="about-description__w">
      ...
      <ul class="about-description__l">
        <li class="about-description__l-i">
          ...
          <div class="about-description__l-p">
            <div class="about-description__l-p__d"><img src="<?php bloginfo('template_directory'); ?>/svg/about/decor__2.svg" alt="icons"></div><img src="<?php bloginfo('template_directory'); ?>/img/about/main/img__1.png" alt="img">
          </div>
        </li>
        <li class="about-description__l-i">
          <div class="about-description__l-t"> 
          ...
          <div class="about-description__l-p">
            <div class="about-description__l-p__d"><img src="<?php bloginfo('template_directory'); ?>/svg/about/decor__4.svg" alt="icons"></div><img src="<?php bloginfo('template_directory'); ?>/img/about/main/img__2.png" alt="img">
          </div>
        </li>
        <li class="about-description__l-i">
          <div class="about-description__l-t"> 
